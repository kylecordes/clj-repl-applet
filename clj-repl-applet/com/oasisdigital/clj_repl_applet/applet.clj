...
(ns com.oasisdigital.clj-repl-applet.applet
  (import javax.swing.JApplet)
  (:gen-class
    :extends javax.swing.JApplet))

(import [javax.swing JFrame JEditorPane JPanel JScrollPane])
(import [javax.swing.text Document DocumentFilter SimpleAttributeSet StyledDocument])
...
(def text "<body face='Consolas, Courier New'><strong>Clojure REPL</strong><br>------------<br>This program was created by Oasis Digital. Type 'about' for more information.")
...
(defn configure-gui [{:keys [frame panel display scrollpane c applet?] :as repl}]
  ...
  ; Settings for JTextPane (where commands are displayed)
